...
var Upload = (function (_super) {
    ...
    Upload.prototype.render = function () {
        var _a = this.props, i18n = _a.i18n, classes = _a.classes, multiple = _a.multiple, submitData = _a.submitData, fileTypes = _a.fileTypes, uploader = _a.uploader, autoStart = _a.autoStart, hideQueue = _a.hideQueue;
        return (React.createElement("form", {method: "POST", encType: "multipart/form-data"}, 
            React.createElement("div", {className: "uploadPanel"}, 
                React.createElement("div", {className: classes.upload}, 
                    i18n.browse, 
                    "…", 
                    React.createElement("input", {type: "file", className: "jqUploadclass", multiple: multiple, "data-form-data": submitData, accept: fileTypes, ref: "upload"})), 
